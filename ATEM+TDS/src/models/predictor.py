...
class Translator(object):
    ...
    def validate(self, data_iter, step, attn_debug=False):
        ...
        with torch.no_grad():
            for batch in data_iter:
                ...
                print(output_data,tgt_data,ext_pred,ext_gold)
    ...
    def translate(self,
        ...
        ext_pred_num = 0
        ext_gold_num = 0
        sum_dialogues = open(r'/home/wangpm/文档/topic-dialog-summ-main/results/summ_dialogues', 'w', encoding='utf-8')
        with torch.no_grad():
            c=0
            rouge = Rouge()
            for batch in data_iter:
                ...
                for idx in range(len(translations)):
                    ...
                    sum_dialogues.write(pred_summ+'\n')
                    print(c)
                    # print('ext_pred',len(ext_pred[idx]))
                    # print('ext_gold',len(ext_gold[idx]))
